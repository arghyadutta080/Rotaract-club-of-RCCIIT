            ...
            <div className='d-flex justify-content-start flex-wrap container'>
                {
                    events.map((event, index) => {
                        return (
                            <div key={index} className='d-flex flex-column justify-content-start align-items-start align-content-around p-3 mx-4 rounded-4 my-2' style={{ backgroundColor: "#D7ECEF", minWidth: "300px", maxWidth: "450px" }}>
