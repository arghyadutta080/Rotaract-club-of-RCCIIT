    ...
    return (
        <div style={{ backgroundColor: "white" }}>
            <div className='container d-flex flex-column py-4'>
                <div style={{ fontFamily: "Lora" }} className="display-5 py-4 mt-2">Rotaract Club of RCCIIT Bulletin</div>
                <div className='d-flex justify-content-evenly flex-wrap'>
                    <div className='py-4'>
                        <img src={RotaTimeVol_4} alt="_rotateam-vol.4" style={{ width: "310px", border: "1px solid #D9D9D9" }} className='rounded mb-4' />
                    </div>
                    <div className='d-flex flex-column justify-content-center align-items-center mb-4'>
                        ...
                        <p className='mt-3'>
                            <button className="btn btn-md d-flex justify-content-between align-items-center fw-semibold py-2 fs-5" onClick={handleDownload} style={{ color: "white", backgroundColor: "#B4637A" }}>
