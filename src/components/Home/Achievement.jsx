...
const Achievement = () => {
    return (
        <div style={{ backgroundColor: "#D9D9D9" }} className='py-4'>
            <div className='container d-flex align-items-center justify-content-around flex-wrap py-4' >
                <div>
                    <img src={achievement} alt="_achievement" style={{ width: "310px" }} className='my-4 py-2 rounded' />
                </div>
                <div className='d-flex align-items-center justify-content-center py-2'>
                    <h1 style={{ fontFamily: "Lora", maxWidth: "600px", }} className="fs-2 text-center">
