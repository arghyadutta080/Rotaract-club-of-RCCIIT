  ...
  return (
    <div className='container mb-4'>
      <div className='mb-4 d-flex flex-column align-items-center justify-content-center' style={{ width: "100%" }}>
        ...
        <div className='d-flex justify-content-center fs-3 my-4 py-2' style={{ fontFamily: "Lora" }}>
          <em style={{ marginRight: "17px" }}>Rotaract Year</em>
          <div className="dropdown ">
            <button className="btn dropdown-toggle fs-5" style={{ backgroundColor: "#D0B9EC" }} type="button" data-bs-toggle="dropdown" aria-expanded="false">
              2022 - 2023
            </button>
        ...
        <button onClick={join_notification} className="btn my-1" type="submit" style={{ color: "white", backgroundColor: "#B4637A" }}><Link className="nav-link fw-semibold fs-6" to="/">Join Us</Link></button>
      </div>
