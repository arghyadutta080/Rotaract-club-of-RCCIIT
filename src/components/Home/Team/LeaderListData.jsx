...
export const row_1 = [
    {
        ...
        name : "Sumit Anand",
        img : president,
        text: `"Leadership is a trait which is inculcated in a span of synergy"

        I am obliged for the opportunity to serve as a President of RC RCCIIT in Rota year 2022-23.
        
        Binding together the knowledge I acquired during my active involvement as Chair of Community Service
        as well as through my serving in designing,it's an asset to pass on the aspects about Rotaract to my
        Smart working juniors as well as batchmates. I aim to rectify the loopholes establish an
    ...
    },
    {
        ...
        from the Rotaract Club of Rcciit is itself a greatful as well as challenging task for me. I will try to hold the
